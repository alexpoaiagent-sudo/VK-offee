...
1. **Навигация по базе проекта:** [перейти](./ru/README.md).
...
- Добавлена «Навигация по базе проекта» (`/ru/`) с оглавлениями разделов.
...
- Обновляй оглавления: профильный `README.md` + «Навигация по базе проекта» (`/ru/`).
